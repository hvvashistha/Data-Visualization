...
public class brainMap extends PApplet {
...
public void draw() {
  ...
  camera(0, -1000, map(mouseY, 0, height, -height * 1.5f, height), 0, 0, 0, 0, 0, -1);
  pushMatrix();
...
class Axis {
  ...
  public Axis(double[] domain, double[] range) {
  ...
  public void settings() {  size(1440,800,P3D); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "brainMap" };
    if (passedArgs != null) {
